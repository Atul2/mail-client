                        ...
                        <div class="row align-items-stretch">
                            <div class="mail-sidebar d-none d-lg-block col-md-2 pt-3 bg-white">
                                <div class="menu-bar">
                                    <ul class="menu-items">
                                        ...
                                        <li class="active"><a href="#"><i class="mdi mdi-email-outline"></i> Inbox</a><span class="badge badge-pill badge-success">8</span>
                                        </li>
                                        <li><a href="#"><i class="mdi mdi-share"></i> Sent</a>
                                        </li>
                                        <li><a href="#"><i class="mdi mdi-file-outline"></i> Draft</a><span class="badge badge-pill badge-warning">4</span>
                                        </li>
                                        <li><a href="#"><i class="mdi mdi-upload"></i> Outbox</a><span class="badge badge-pill badge-danger">3</span>
                                        </li>
                                        <li><a href="#"><i class="mdi mdi-star-outline"></i> Starred</a>
                                        </li>
                                        <li><a href="#"><i class="mdi mdi-delete"></i> Trash</a>
                                        </li>
                                    </ul>
                                    <div class="wrapper">
                                    ...
                                    <ul class="profile-list">
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face1.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face2.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face20.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face12.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face25.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face10.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face23.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face11.jpg" alt="" /></span>
                                                <div class="user">
                                        ...
                                        <li class="profile-list-item">
                                            <a href="#"> <span class="pro-pic"><img src="http://www.urbanui.com/dashflat/template/images/faces/face9.jpg" alt="" /></span>
                                                <div class="user">
                            ...
                            <div class="mail-list-container col-md-3 pt-4 pb-4 border-right bg-white">
                                ...
                                <div class="mail-list">
                                    ...
                                    <div class="details"> <i class="mdi mdi-star-outline"></i>
                                    </div>
                                </div>
                                <div class="mail-list new_mail">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" checked="" /> <i class="input-helper"></i>
                                        </label>
                                    </div>
                                    <div class="content">
                                    ...
                                    <div class="details"> <i class="mdi mdi-star favorite"></i>
                                    </div>
                                </div>
                                <div class="mail-list">
                                    <div class="form-check">
                            ...
                            <div class="mail-view d-none d-md-block col-md-9 col-lg-7 bg-white">
								...
								<br />Sarah Graves</p>
                                    ...
                                    <div class="attachments-sections">
                                        <ul>
                                            <li>
                                                <div class="thumb"><i class="mdi mdi-file-pdf"></i>
                                                </div>
                                                <div class="details">
                                                    <p class="file-name">Seminar Reports.pdf</p>
                                                    <div class="buttons">
                                                        <p class="file-size">678Kb</p> <a href="#" class="view">View</a>  <a href="#" class="download">Download</a>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="thumb"><i class="mdi mdi-file-image"></i>
                                                </div>
                                                <div class="details">
                                                    <p class="file-name">Product Design.jpg</p>
                                                    <div class="buttons">
                                                        <p class="file-size">1.96Mb</p> <a href="#" class="view">View</a>  <a href="#" class="download">Download</a>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
